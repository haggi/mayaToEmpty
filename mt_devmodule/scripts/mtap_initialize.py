...
class AppleseedRenderer(Renderer.MayaToRenderer):
    ...
    def theRenderer(arg=None):
        if not AppleseedRenderer.theRendererInstance:
            ...
            # AppleseedRenderer.theRendererInstance = AppleseedRenderer(RENDERER_NAME , "mt_initialize")
    ...
    def __init__(self, rendererName, moduleName):
        ...
        self.aovShaders = ["mt_aoShader", "mt_aoVoxelShader", "mt_diagnosticShader", "mt_fastSSSShader", "appleseedSurfaceShader"]
...
#                         pm.connectControl(xmlDict['xmlFile'], self.renderGlobalsNodeName + ".exportSceneFileName", index=2)
    ...
    def registerNodeExtensions(self):
        ...
        pm.addExtension(nodeType="camera", longName="mt_diaphragm_blades", attributeType="long", defaultValue=0)
        pm.addExtension(nodeType="camera", longName="mt_diaphragm_tilt_angle", attributeType="float", defaultValue=0.0)
        pm.addExtension(nodeType="camera", longName="mt_latLongLens", attributeType="bool", defaultValue=False)
        
        # mesh
        pm.addExtension(nodeType="mesh", longName="mt_mesh_useassembly", attributeType="bool", defaultValue=False)
        pm.addExtension(nodeType="mesh", longName="mt_ray_bias_method", attributeType="enum", enumName="none:normal:incoming_direction:outgoing_direction", defaultValue=0)
        pm.addExtension(nodeType="mesh", longName="mt_ray_bias_distance", attributeType="float", defaultValue=0.0)
        pm.addExtension(nodeType="mesh", longName="mt_standin_path", dataType="string", usedAsFilename=True)
        pm.addExtension(nodeType="mesh", longName="mt_visibleLights", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="mesh", longName="mt_visibleProbe", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="mesh", longName="mt_visibleGlossy", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="mesh", longName="mt_visibleSpecular", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="mesh", longName="mt_visibleDiffuse", attributeType="bool", defaultValue=True)

        pm.addExtension(nodeType="spotLight", longName="mt_cast_indirect_light", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="spotLight", longName="mt_importance_multiplier", attributeType="float", defaultValue=1.0)
        pm.addExtension(nodeType="directionalLight", longName="mt_cast_indirect_light", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="directionalLight", longName="mt_importance_multiplier", attributeType="float", defaultValue=1.0)
        pm.addExtension(nodeType="pointLight", longName="mt_cast_indirect_light", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="pointLight", longName="mt_importance_multiplier", attributeType="float", defaultValue=1.0)
        ...
        pm.addExtension(nodeType="areaLight", longName="mt_visibleLights", attributeType="bool", defaultValue=False)
        pm.addExtension(nodeType="areaLight", longName="mt_visibleProbe", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="areaLight", longName="mt_visibleGlossy", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="areaLight", longName="mt_visibleSpecular", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="areaLight", longName="mt_visibleDiffuse", attributeType="bool", defaultValue=True)
        pm.addExtension(nodeType="areaLight", longName="mt_visibleTransparency", attributeType="bool", defaultValue=True)
        
        # shading group
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_bsdf", attributeType="message")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_surfaceShader", attributeType="message")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_edf", attributeType="message")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_alphaMap", usedAsColor=True, attributeType="float3")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_alphaMapR",attributeType = "float", parent="mt_mat_alphaMap")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_alphaMapG",attributeType = "float", parent="mt_mat_alphaMap")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_alphaMapB",attributeType = "float", parent="mt_mat_alphaMap")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_normalMap", usedAsColor=True, attributeType="float3")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_normalMapR",attributeType = "float", parent="mt_mat_normalMap")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_normalMapG",attributeType = "float", parent="mt_mat_normalMap")
#        pm.addExtension(nodeType="shadingEngine", longName="mt_mat_normalMapB",attributeType = "float", parent="mt_mat_normalMap")
    ...
    def preRenderProcedure(self):
        ...
        if self.renderGlobalsNode.useOptimizedTextures.get():
            ...
            mt_optimizeTextures.preRenderOptimizeTextures(optimizedFilePath=self.renderGlobalsNode.optimizedTexturePath.get())
            shaderTools.createAutoShaderNodes()
        
        OSLTools.compileAllShaders()
        
    def postRenderProcedure(self):
        mt_optimizeTextures.postRenderOptimizeTextures()
