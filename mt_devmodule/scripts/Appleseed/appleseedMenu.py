...
class BinaryMesh(object):
    def __init__(self, meshList = None):
        ...
        self.path = pm.optionVar.get('mt_binMeshExportPath', pm.workspace.path + "/geo/export.binarymesh")
        self.prefix = pm.optionVar.get('mt_binMeshExportPathPrefix', "prefix")
        self.doProxy = pm.optionVar.get('mt_binMeshCreateProxy', True)
        self.percentage = pm.optionVar.get('mt_binMeshPercentage', 0.1)
        self.createStandin = pm.optionVar.get('mt_binMeshCreateStandin', True)
        self.oneFilePerMesh = pm.optionVar.get('mt_binMeshOneFilePerMesh', False)
        self.useTransform = pm.optionVar.get('mt_binMeshUseTransform', False)
    ...
    def loadStandins(self):
        ...
        standInMeshNode = pm.createNode("mt_standinMeshNode")
...
class StandinOptions(pm.ui.Window):
    ...
    def getData(self, *args):        
        ...
        pm.optionVar['mt_binMeshExportPath'] = path
        pm.optionVar['mt_binMeshExportPathPrefix'] = prefix
        pm.optionVar['mt_binMeshCreateProxy'] = doProxy
        pm.optionVar['mt_binMeshPercentage'] = percentage
        pm.optionVar['mt_binMeshCreateStandin'] = createStdin
        pm.optionVar['mt_binMeshOneFilePerMesh'] = oneFilePerMesh
        pm.optionVar['mt_binMeshUseTransform'] = useTransform
    ...
    def perform(self, *args):        
        ...
        path = pm.optionVar.get('mt_binMeshExportPath', pm.workspace.path + "/geo/export.binarymesh")
        prefix = pm.optionVar.get('mt_binMeshExportPathPrefix', "prefix")
        doProxy = pm.optionVar.get('mt_binMeshCreateProxy', True)
        percentage = pm.optionVar.get('mt_binMeshPercentage', 0.1)
        createStandin = pm.optionVar.get('mt_binMeshCreateStandin', True)
        oneFilePerMesh = pm.optionVar.get('mt_binMeshOneFilePerMesh', False)
        useTransform = pm.optionVar.get('mt_binMeshUseTransform', False)
...
#TODO: convert namespace to clean name
    ...
    def initUI(self):
        ...
        binMeshExportPath = pm.optionVar.get('mt_binMeshExportPath', pm.workspace.path + "/geo/export.binarymesh")
        prefix = pm.optionVar.get('mt_binMeshExportPathPrefix', "prefix")
        createProxy = pm.optionVar.get('mt_binMeshCreateProxy', True)
        percentage = pm.optionVar.get('mt_binMeshPercentage', 0.1)
        createStandin = pm.optionVar.get('mt_binMeshCreateStandin', True)
        oneFilePerMesh = pm.optionVar.get('mt_binMeshOneFilePerMesh', False)
        useTransform = pm.optionVar.get('mt_binMeshUseTransform', False)
